...
def describe_image(image_path, prompt_type = 'general'):
    ...
    prompts = {
        'general': {
            'system': "You are a helpful assistant that describes images for visually impaired users. Start each description with 'General:'",
            'user': "Describe this image in detail for a visually impaired person."
        },
        'exam': {
            'system': "You are a helpful assistant that describes images for exam purposes.Start each description with 'Exam:'",
        ...
        'dataStructures': {
            'system': "You are a helpful assistant that only describes images related to data structures.Start each description with 'data structure:'",
